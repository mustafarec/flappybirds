...
1. `SkyHopper.xcodeproj` dosyasını Xcode'da açın.
...
- İlerledikçe engeller kontrollü biçimde hızlanır ve sıklaşır.
- Sesler başlangıç ekranından açılıp kapatılabilir.
- Yere, tavana veya bir geçide çarpmak oyunu bitirir.

## Gizlilik

Sky Hopper hesap, reklam veya analitik kullanmaz ve kişisel veri toplamaz. En yüksek skor yalnızca cihazdaki `UserDefaults` alanında saklanır. Ayrıntılar: [Privacy Policy](https://mustafarec.github.io/flappybirds/privacy/).
...
Planlanan ve tamamlanan işler için [`roadmap.md`](roadmap.md) dosyasına bakın.
